...
---
This post describes the motivation behind the Curation of Neurodegeneration Supporting Ontology (CONSO) which was created under my supervision while I ran the curation program at Fraunhofer for the [Human Brain Pharmacome](https://pharmacome.github.io) project.
More importantly, it's an example following the guidelines I proposed in a [previous blog post]({% post_url 2020-05-12-building-an-ontology %}).
