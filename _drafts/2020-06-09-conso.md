...
The fourth CV referenced at the top, the [Neuroimaging Feature Terminology](https://doi.org/10.3233/jad-161148) only existed as a [Biological Expression Language (BEL)](https://biological-expression-language.github.io/) namespace file served by Fraunhofer's web-based BEL curation interface.
