...
---
While I lead the curation program in the [Human Brain Pharmacome](https://pharmacome.github.io) project at Fraunhofer, we generated the Curation of Neurodegeneration Supporting Ontology (CONSO). This post describes the need for quality control and re-curation that lead to its generation, as well as being an example of how to follow the guidelines I proposed in a [previous blog post]({% post_url 2020-05-12-building-an-ontology %}).
