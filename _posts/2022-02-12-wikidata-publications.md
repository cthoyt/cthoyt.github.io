...
using [Scholia](https://scholia.toolforge.org/) and the
...
2. Store your Wikidata credentials in a configuration file at
   `~/.config/wikidata.ini` (where `~` means your home directory). It should
   look like:
...
done this already, go back and read [this
tutorial]({% post_url 2021-08-17-self-organization %}). Before continuing, make
...
2. [Scholia](https://scholia.toolforge.org) is a frontend for navigating
   ...
   `https://scholia.toolforge.org/author/<YOUR Q NUMBER>/curation#missing-author-resolving`
...
4. This will bring you to the
   [Author Disambiguator](https://author-disambiguator.toolforge.org) page.
