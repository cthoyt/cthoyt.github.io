...
successful_remapped_request = requests.get(
    "http://localhost:5000/resolve/DO:14330"
).json()
...
unsuccessful_crazy_request = requests.get(
    "http://localhost:5000/resolve/DO:thisIsNotRightAtAll"
).json()
...
unsuccessful_prefix_lookup = requests.get(
    "http://localhost:5000/resolve/notanamespace:0000"
).json()
