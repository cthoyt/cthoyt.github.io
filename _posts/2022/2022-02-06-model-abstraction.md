...
post]({% post_url 2022/2022-02-06-model-refactoring %}) on refactoring and
improving a machine learning model implemented with
[PyTorch](https://pytorch.org), this post will be a tutorial on how to
generalize the implementation of a
