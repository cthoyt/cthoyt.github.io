...
[ChEMBL]({% post_url 2021/2021-08-05-taming-chembl-sql %}), this post describes
...
>    preferred identity provider at the UTS homepage.
> 2. Complete and submit the license request form. NLM will send the license
>    approval e-mail within 5 business days after reviewing your authenticated
>    license request.
> 3. You will sign in using identity provider credentials to download files or
>    access web interfaces that require UTS authentication such as the UTS,
>    VSAC, SNOMED CT, or RxNorm.
...
3. Further, we hope that data is permissively licensed such that it can be
   reused, modified, and re-distributed. The Creative Commons
