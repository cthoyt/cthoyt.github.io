...
[DrugBank]({% post_url 2020/2020-12-14-taming-drugbank %}),
[ChEMBL]({% post_url 2021/2021-08-05-taming-chembl-sql %}),
[UMLS]({% post_url 2023/2023-09-01-umls %}),
[ORCiD]({% post_url 2024/2024-06-08-easy-orcid %}), and
[ClinicalTrials.gov]({% post_url 2025/2025-01-23-clinical-trials-data-modeling %}).
...
looks for [HGNC]({% post_url 2025/2025-10-15-databases-as-ontologies-2-hgnc %}).
