...
demonstration]({% post_url 2025/2025-12-19-annotating-the-literature-demo %})
using the underlying NER and NEN technology stack, but just using MeSH - a
future post will show how this works with a coherent lexica for diseases, genes,
