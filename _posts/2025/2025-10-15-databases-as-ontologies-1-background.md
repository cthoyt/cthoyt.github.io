...
the [second part]({% post_url 2025/2025-10-15-databases-as-ontologies-2-hgnc %})
...
used a syntax similar to [CURIEs]({% post_url 2021/2021-09-14-curies %}) for
...
business]({% post_url 2020/2020-04-28-history-of-bel %}), but, because the
namespace files relied on names instead of identifiers, they quickly became out
of date. Naturally, I wanted to renew the existing BEL namespace files and also
create new ones for additional ontologies to support the curation I was doing.
...
part]({% post_url 2025/2025-10-15-databases-as-ontologies-2-hgnc %}), where I
