...
[my recent
post]({% post_url 2025/2025-04-17-chembl-indications-efo-exploration %}) about
the EFO identifier column in ChEMBL's diseases table, the `pref_name` column in
the compounds table might not actually mean what I guess it does.
