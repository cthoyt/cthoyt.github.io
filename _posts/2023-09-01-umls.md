...
[HPO](https://bioregistry.io/hpo), [LOINC](https://bioregistry.io/loinc), and more. Anything that can be loaded as an
ontology in PyOBO can also be exported with SSSOM. For UMLS, this looks like:
